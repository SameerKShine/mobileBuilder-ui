...
function PublishApp() {
  ...
  const validate = (values) => {
    ...
    } else if (!urlValidate.test(values.supportUrl)) {
            ...
            <div className="first_section">
              <div style={{ width: "65%" }}>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setPublishData({ ...publishData, keywords: e })
                  }
                  // options={options}
                />
            ...
            <div className="first_section">
              ...
              <div style={{ width: "48%" }}>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setPublishData({ ...publishData, country_name: e })
                  }
                />
              </div>
            </div>
